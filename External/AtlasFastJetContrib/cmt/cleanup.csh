...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=AtlasFastJetContrib -version=AtlasFastJetContrib-01-14-01 -path=/afs/cern.ch/work/q/qzeng/gbb/DerivationFramework/JETM8/20.1.5.7/External  $* >${cmtAtlasFastJetContribtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=AtlasFastJetContrib -version=AtlasFastJetContrib-01-14-01 -path=/afs/cern.ch/work/q/qzeng/gbb/DerivationFramework/JETM8/20.1.5.7/External  $* >${cmtAtlasFastJetContribtempfile}"
