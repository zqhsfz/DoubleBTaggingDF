...
${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=DerivationFrameworkJetEtMiss -version=DerivationFrameworkJetEtMiss-00-02-56 -path=/afs/cern.ch/work/q/qzeng/gbb/DerivationFramework/JETM8/20.1.5.7/PhysicsAnalysis/DerivationFramework  -no_cleanup $* >${cmtDerivationFrameworkJetEtMisstempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe setup -csh -pack=DerivationFrameworkJetEtMiss -version=DerivationFrameworkJetEtMiss-00-02-56 -path=/afs/cern.ch/work/q/qzeng/gbb/DerivationFramework/JETM8/20.1.5.7/PhysicsAnalysis/DerivationFramework  -no_cleanup $* >${cmtDerivationFrameworkJetEtMisstempfile}"
