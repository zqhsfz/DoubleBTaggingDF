...
DerivationFrameworkJob += CfgMgr.DerivationFramework__DerivationKernel(	name = "JETM3Kernel",
...
addMETOutputs(JETM3SlimmingHelper,["Diagnostic","AntiKt4LCTopo","AntiKt4EMPFlow","Track"])
