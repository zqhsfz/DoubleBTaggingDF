...
DerivationFrameworkJob += CfgMgr.DerivationFramework__DerivationKernel(	name = "JETM7Kernel", 
...
addMETOutputs(JETM7SlimmingHelper,["Diagnostic","AntiKt4LCTopo","AntiKt4EMPFlow","Track"])
