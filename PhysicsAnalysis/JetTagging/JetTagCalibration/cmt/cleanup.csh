...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=JetTagCalibration -version=JetTagCalibration-00-02-28 -path=/afs/cern.ch/work/q/qzeng/gbb/DerivationFramework/JETM8/20.1.5.7/PhysicsAnalysis/JetTagging  $* >${cmtJetTagCalibrationtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=JetTagCalibration -version=JetTagCalibration-00-02-28 -path=/afs/cern.ch/work/q/qzeng/gbb/DerivationFramework/JETM8/20.1.5.7/PhysicsAnalysis/JetTagging  $* >${cmtJetTagCalibrationtempfile}"
