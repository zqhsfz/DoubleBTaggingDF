#ifndef JETTAGTOOLS_MV1CTAG_H
#define JETTAGTOOLS_MV1CTAG_H
...
namespace Analysis { 
  ...
  class MV1cTag : public AthAlgTool , virtual public ITagTool {
   
  public:
    MV1cTag(const std::string&,const std::string&,const IInterface*);
  ...
  inline void MV1cTag::setOrigin(const xAOD::Vertex* priVtx) { m_priVtx=priVtx; }
