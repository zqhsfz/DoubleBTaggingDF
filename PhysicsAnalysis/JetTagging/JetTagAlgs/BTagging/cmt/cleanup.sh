...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=BTagging -version=BTagging-00-07-43 -path=/afs/cern.ch/work/q/qzeng/gbb/DerivationFramework/JETM8/20.1.5.7/PhysicsAnalysis/JetTagging/JetTagAlgs  $* >${cmtBTaggingtempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -sh -pack=BTagging -version=BTagging-00-07-43 -path=/afs/cern.ch/work/q/qzeng/gbb/DerivationFramework/JETM8/20.1.5.7/PhysicsAnalysis/JetTagging/JetTagAlgs  $* >${cmtBTaggingtempfile}"
  cmtcleanupstatus=2
